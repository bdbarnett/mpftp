...
> **Note on flash/RAM columns:** for **ESP32** boards the flash size and PSRAM
> are *measured* by esptool. For non-ESP boards the flash/RAM shown are the
> chip/board **nominal specs** (the campaign only read runtime free-heap there),
> flagged with `~`.
...
| # | Board / model | Chip / MCU | Port | Flash | RAM / free heap | Runtime seen | Interface |
|---|---------------|-----------|------|-------|-----------------|--------------|-----------|
...
| 5 | Adafruit Metro M7 | i.MX RT1011DAE5A | mimxrt | ~ext QSPI | ~60 KB free | MicroPython 1.22 | Adafruit VID |
| 6 | ESP32-S3 module (Arduino) | ESP32-S3 (v0.2) | esp32 | 8 MB | Embedded PSRAM 8 MB | Arduino / bare | native USB-JTAG |
| 7 | Adafruit Feather RP2040 | RP2040 | rp2 | ~8 MB | ~217 KB free | MicroPython 1.20 | Adafruit VID |
...
| 11 | Waveshare RP2040-Plus 4MB | RP2040 | rp2 | ~4 MB | ~178 KB free | CircuitPython 9.0.5 | RPi VID |
...
| 16 | Raspberry Pi Pico | RP2040 | rp2 | ~2 MB | ~226 KB free | MicroPython 1.23-pre | RPi VID |
...
| 19 | Seeed XIAO nRF52840 Sense | nRF52840 | nrf | ~1 MB + QSPI | ~140 KB free | CircuitPython 8.2 | Seeed VID |
| 20 | ESP32-PICO-V3-02 board | ESP32-PICO-V3-02 (v3.0) | esp32 | 8 MB | Embedded PSRAM | bare | WCH CH9102 |
| 21 | Adafruit Feather RP2040 DVI | RP2040 | rp2 | ~8 MB | ~106 KB free | CircuitPython 8.2 (252 MHz OC) | Adafruit VID |
| 22 | Generic ESP32-S3 module | ESP32-S3 | esp32 | 8 MB | ~248 KB (no PSRAM) | MicroPython 1.21 | native USB-JTAG |
| 23 | Teensy 4.1 | i.MX RT1062DVJ6A | mimxrt | ~8 MB | ~927 KB free | CircuitPython 8.2 → MP 1.29 | Adafruit CDC / HalfKay |
| 24 | SparkFun Thing Plus SAMD51 | SAMD51J20 | samd | ~1 MB | ~216 KB free | CircuitPython 8.2 | SparkFun VID |
| 25 | ST NUCLEO-H743ZI2 | STM32H743 | stm32 | ~2 MB | ~455 KB free | MicroPython 1.23-pre → 1.29 | ST-Link MSD |
| 26 | Adafruit PyRuler | SAMD21E18 | samd | ~256 KB | ~32 KB | CircuitPython 8.2 | Adafruit VID |
| 27 | Adafruit PyGamer | SAMD51J19 | samd | ~512 KB | ~155 KB free | CircuitPython 9.0.3 | Adafruit VID |
| 28 | ESP32-PICO-V3-02 board | ESP32-PICO-V3-02 (v3.0) | esp32 | 8 MB | Embedded PSRAM (~2 MB free) | → MP 1.29 SPIRAM | WCH CH9102 |
| 29 | Adafruit Feather nRF52840 Express | nRF52840 | nrf | ~1 MB + QSPI | ~141 KB free | CircuitPython 8.2 → MP 1.29 | Adafruit VID |
...
**NXP i.MX RT (`mimxrt`)**
- **#5 Metro M7** — entry i.MX RT1011 at 500 MHz, tiny (~60 KB) internal RAM.
